...
Resolve an issue when it's fixed or you don't expect it to happen again. You can do this manually or by [including the issue ID in a commit](/product/releases/adding-commits/#resolve-issues-by-commit). In addition, you can resolve issues by setting the auto-resolve value.
