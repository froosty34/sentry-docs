...
Now suspect commits and suggested assignees should start appearing on the **Issue Details** page. Sentry determines these with files observed in the stack trace, authors of those files, and ownership rules.
...
Stack trace links allows you to jump from a stack trace in Sentry to the corresponding file in your source code provider. This is done by matching the file path in the stack trace to the file path in your source code provider.
