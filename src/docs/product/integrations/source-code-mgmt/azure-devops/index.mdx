...
- If you have multiple accounts in Azure DevOps, open [this link to Azure DevOps](https://aex.dev.azure.com) in another tab, select the correct account, then reinstall.
 ...
 If reinstallation solves the problem, please upvote [that solution in GitHub](https://github.com/getsentry/sentry/issues/14357), which is where we're tracking this improvement.
